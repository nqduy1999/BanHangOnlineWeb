  ...
  return (
      <tbody>
        <tr className="row100">
          ...
          <td className="column100 column2" data-column="column2">{props.user.identityCard ? props.user.identityCard : "Khách hàng chưa cập nhật CMND ! "}</td>
          ...
          <td className="column100 column5" data-column="column8">
            <button className=" btn btn-danger" data-toggle="modal" data-target="#xemchitiethd" onClick={OrderView}>Xem</button>
          </td>
        </tr>
      </tbody>
